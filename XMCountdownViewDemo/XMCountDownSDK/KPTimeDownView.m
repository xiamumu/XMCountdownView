...
@interface KPSingleNumLabel : UIButton
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        UILabel *dayLab = [UILabel addLabelWithTitle:@"天" bgColor:HexColor(#8a8a8a) font:UIFont_17];
        [self addSubview:dayLab];
        self.dayLab = dayLab;
        UILabel *hourLab = [UILabel addLabelWithTitle:@"时" bgColor:HexColor(#8a8a8a) font:UIFont_17];
        [self addSubview:hourLab];
        self.hourLab = hourLab;
        UILabel *minuteLab = [UILabel addLabelWithTitle:@"分" bgColor:HexColor(#8a8a8a) font:UIFont_17];
